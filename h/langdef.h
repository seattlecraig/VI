...
pick_lang( LANG_AWK,      VI_LANG_LANG15, "AWK",      "AWK",      "awk.dat" )
pick_lang( LANG_CSHARP,   VI_LANG_LANG17, "C#",       "C#",       "csharp.dat" )
pick_lang( LANG_XML,      VI_LANG_LANG18, "XML",      "XML",      "xml.dat" )
pick_lang( LANG_JSON,     VI_LANG_LANG19, "JSON",     "JSON",     "json.dat" )
pick_lang( LANG_JS,       VI_LANG_LANG20, "JavaScript", "JavaScript", "javascript.dat" )
pick_lang( LANG_TS,       VI_LANG_LANG21, "TypeScript", "TypeScript", "typescript.dat" )
pick_lang( LANG_USER,     VI_LANG_LANG22, "User",     "User",     "user.dat" )
